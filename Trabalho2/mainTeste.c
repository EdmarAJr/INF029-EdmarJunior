...
void testeCriarEstrutura()
{
	...
	//printf("%d\n", criarEstruturaAuxiliar(4, 5) == SUCESSO);
	//printf("%d\n", criarEstruturaAuxiliar(3, 7579198) == SEM_ESPACO_DE_MEMORIA);
}
/*
2 [ , , ]
*/
...
void testeInserirComEstrutura()
{
	...
	//printf("%d\n", inserirNumeroEmEstrutura(9, 5) == SEM_ESTRUTURA_AUXILIAR);
	//printf("%d\n", inserirNumeroEmEstrutura(-2, 5) == POSICAO_INVALIDA);
}
/*
2 [4,-2,6]
*/
...
void testeListar()
{
	...
	int vet[2]; //criar um vetor com 2 posicoes para receber os dados da estrutura auxiliar. Esse vetor eh tratatado como um ponteiro na funcao getDadosEstruturaAuxiliar() e getDadosOrdenadosEstruturaAuxiliar()
	/*_______________________________________________________*/
	// printf("Meus testes: inicio\n");
	// int vetor[5];
	// printf("1º %d\n", criarEstruturaAuxiliar(10, 5) == SUCESSO);
	
	// printf("2º %d\n", inserirNumeroEmEstrutura(10, 5) == SUCESSO);
	// printf("3º %d\n", inserirNumeroEmEstrutura(10, 2) == SUCESSO);
	// printf("4º %d\n", inserirNumeroEmEstrutura(10, 0) == SUCESSO);
	// printf("5º %d\n", inserirNumeroEmEstrutura(10, 8) == SUCESSO);
	// printf("6º %d\n", inserirNumeroEmEstrutura(10, 4) == SUCESSO);
	// printf("7º %d\n", getDadosEstruturaAuxiliar(10, vetor) == SUCESSO);
	// printf("8º %d\n", getDadosOrdenadosEstruturaAuxiliar(10, vetor) == SUCESSO);
	// printf("9º %d\n", vetor[0] == 0);
	// printf("10º %d\n", vetor[2] == 4);
	// printf("11º %d\n", vetor[4] == 8);
	// printf("%d\n", excluirNumeroEspecificoDeEstrutura(10, 4) == SUCESSO);
	// printf("%d\n", excluirNumeroEspecificoDeEstrutura(10, 5) == SUCESSO);
	// printf("%d\n", excluirNumeroEspecificoDeEstrutura(10, 2) == SUCESSO);
	// printf("%d\n", excluirNumeroEspecificoDeEstrutura(10, 0) == SUCESSO);
	// printf("%d\n", excluirNumeroEspecificoDeEstrutura(10, 8) == SUCESSO);
	// printf("Meus testes: fim\n");
	/*_______________________________________________________*/
	printf("%d\n", getDadosEstruturaAuxiliar(1, vet) == SEM_ESTRUTURA_AUXILIAR);
	printf("%d\n", getDadosEstruturaAuxiliar(11, vet) == POSICAO_INVALIDA); //tenta inserir o vetor com 2 posicoes na posicao 11 que nao existe
	printf("%d\n", getDadosEstruturaAuxiliar(2, vet) == SUCESSO);

	printf("%d\n", vet[0] == 7); //testa se o valor 7 foi inserido no vetor e se o vetor existe. Retorna 1 se true e 0 se false.
	printf("%d\n", vet[1] == -9);
